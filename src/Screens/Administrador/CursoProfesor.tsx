  ...
  return(
    <View style={style.container}>
      <View style={style.header}>
        <Text style={style.text_header}>Curso Estudiante</Text>
      </View>
      ...
      <Text style={style.text_header}>Curso</Text>
        ...
        <TouchableOpacity  style={style.signIn}>
                  <Text style={[style.textSign,{color:'#fff'}]}>Buscar Curso</Text>
        </TouchableOpacity>
        </View>
        <View>
          ...
          <Text style={style.text_header}>Estudiantes Agregados</Text>
          <SafeAreaView style={style.conteinerAllStudent}>
            <FlatList
              data={DATA}
              renderItem={renderItem}
