...
const CrearDocente = (props:HAdminitrador) => {
  ...
  const devolver=async()=>{
    ...
    if(name.length!=0 && apellido1.length!=0 && apellido2.length!=0 && identificacion.length!=0 && correo.length!=0){
  ...
  return(
    <View style={style.container}>
      <View style={style.header}>
        <Text style={style.text_header}>Agregar Docente</Text>
      </View>
      <Animatable.View  animation="fadeInUpBig" style={style.footer}>
        <View style={style.containerButton}>
          ...
          <View>
            <Input placeholder="Apellido 1" onChangeText={(text) => setApellido1(text)} />
          </View>
          <View>
            <Input placeholder="Apellido 2" onChangeText={(text) => setApellido2(text)} />
          </View>
          <View>
